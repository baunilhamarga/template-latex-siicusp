...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\includegraphics[width=\imagewidth, height=\imageheight]{Figures/logo_33_en.pdf}} % Set image size to 3x3 cm
\renewcommand{\headrulewidth}{0pt}

% Font settings for Arial and indentation
...
\begin{table}[t]
    ...
    \begin{tabular}{cccc}
    \hline
    Dataset & Model & Accuracy (\%) & Time (s) \\ \hline
    \multirow{6}{*}{Facies} 
    & XGBoost   & 90.40                & 0.272                        \\
    & XGBoost*  & 91.50                & 4.754                        \\
...
\bibliographystyle{ieeetran[en-us]}
